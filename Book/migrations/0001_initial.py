    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='book1', to='Book.Book')),
                ('book2', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='book2', to='Book.Book')),
            ],
        ),
    ]
